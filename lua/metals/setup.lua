...
M.initialize_or_attach = function(config)
  assert(
    config,
    'Make sure you have a config. If you want the defaults, just use {}'
    )
  ...
  config.handlers['metals/quickPick'] =
    config.handlers['metals/quickPick'] or handlers['metals/quickPick']

  config.handlers['metals/inputBox'] =
    config.handlers['metals/inputBox'] or handlers['metals/inputBox']
  ...
  config.handlers['textDocument/hover'] =
    config.handlers['textDocument/hover'] or handlers['textDocument/hover']

  config.handlers['metals/status'] =
    config.handlers['metals/status'] or handlers['metals/status']

  config.handlers['metals/publishDecorations'] =
    config.handlers['metals/publishDecorations'] or handlers['metals/publishDecorations']
